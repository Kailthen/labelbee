...
export interface ISegmentByPointsProps extends IBasicToolOperationProps {
  style: any;
  forbidAddNew?: boolean;
  forbidDelete?: boolean;
}
class SegmentByPoints extends BasicToolOperation {
  ...
  constructor(props: ISegmentByPointsProps) {
    super(props);
    ...
    this.config.attributeList = attributeList;
    this.pointList = [];
    this.markerIndex = 0;
...
export default SegmentByPoints;
